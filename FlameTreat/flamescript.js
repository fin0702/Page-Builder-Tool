const scrollContainer = document.querySelector(".progress-section");
...
//defines object as being draggable
    ...
    if(($("#object7").is('.ui-draggable-dragging'))&&($("#object7").is('.dropped'))){$("#object7").removeClass('dropped');$("#dropzone").removeClass('error')};
